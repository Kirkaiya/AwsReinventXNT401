...
curl -o aspnetmvc.zip kirk-docs-share.s3-us-west-2.amazonaws.com/aspnetwebapi.zip
sudo apt install unzip -y
sudo unzip aspnetmvc.zip -d aspnetmvc
sudo chmod +rwx aspnetmvc
sudo /usr/bin/dotnet/dotnet run --project aspnetmvc/aspnet.csproj